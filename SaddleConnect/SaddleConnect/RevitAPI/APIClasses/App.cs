...
namespace SaddleConnect
{
    ...
    {
        public static PushButton SaddleConnectButton { get; set; }
        ...
        {
            SaddleConnectButton.Enabled = true;
            return Result.Succeeded;
        }
        ...
        private void OnButtonCreate(UIControlledApplication application)
        {
            ...
            BitmapImage pb1Image = new BitmapImage(new Uri("pack://application:,,,/SaddleConnect;component/Resources/32x32.png"));
            buttondata.LargeImage = pb1Image;

            BitmapImage pb1Image2 = new BitmapImage(new Uri("pack://application:,,,/SaddleConnect;component/Resources/16x16.png"));
            buttondata.Image = pb1Image2;

            var ribbonPanel = RibbonPanel(application);


            SaddleConnectButton = ribbonPanel.AddItem(buttondata) as PushButton;
            string path;
            ...
            ContextualHelp contextHelp = new ContextualHelp(
                ...
                path + "\\Vconnect.html"); // hard coding for simplicity. 

            SaddleConnectButton.SetContextualHelp(contextHelp);
        }
